          ...
          <h2 className="text-3xl uppercase tracking-wider text-center mb-16 text-white font-light">
            ...
            <div className="space-y-6 max-w-md mx-auto">
              <div className="flex items-start p-6 rounded-2xl bg-purple-100/80 backdrop-blur-sm border border-purple-200/50 shadow-lg">
                <svg className="w-6 h-6 mr-4 mt-1 text-purple-600" viewBox="0 0 24 24" fill="currentColor">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-purple-700">
                    Follow us on Instagram for the latest updates and collections
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start p-6 rounded-2xl bg-purple-100/80 backdrop-blur-sm border border-purple-200/50 shadow-lg">
                <MapPin className="w-6 h-6 mr-4 mt-1 text-purple-600" />
                <div className="flex-1">
                  <a
                  ...
                  <p className="text-sm text-purple-700">
                  Jl. Bintara VIII No. 2, RT.005/RW.003, Bintara, Kec. Bekasi Barat, Kota
                  Bekasi, Jawa Barat, 17134
                  </p>
                </div>
              </div>
            </div>
